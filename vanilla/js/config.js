...
const CONFIG = {
  ...
  CURRENCY: "$",
  COCOBASE_ENABLED: false, // Set to true after adding actual keys from cocobase.buzz
  MOCK_DB_DELAY: 800,
  STORAGE_KEYS: {
...
const PRODUCTS = [
  // ... (keeping existing product data for fallback)
  {
    id: "p1",
    ...
    price: 999.99,
    image:
      "https://images.unsplash.com/photo-1598327105666-5b89351af9dc?q=80&w=1000&auto=format&fit=crop",
    description:
      "Next-generation hologram display with neural processing architecture.",
  ...
  },
  {
    ...
    description:
      "Ultra-thin liquid metal cooling system with carbon-fiber chassis.",
  ...
  },
  {
    ...
    description:
      "Bone conduction technology with immersive spatial audio experience.",
  ...
  },
  {
    ...
    price: 3899.99,
    image:
      "https://images.unsplash.com/photo-1624705002806-5d72df19c3ad?q=80&w=1000&auto=format&fit=crop",
...
// CocoBase Configuration (Official Keys)
const cocobaseConfig = {
...
// Initialize Cocobase if script is loaded
if (typeof Cocobase !== "undefined") {
  db = new Cocobase(cocobaseConfig);
  console.log("Cocobase initialized. Project:", cocobaseConfig.projectId);
}

// Global Firebase variables (Keep for structural compatibility if needed, but disabled)
let auth = null;
let firestore = null;
